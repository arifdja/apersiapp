  ...
  callWithJQuery(function($) {
    ...
    locales = {
      en: {
        ...
        renderers: renderers,
        localeStrings: {
          renderError: "Terjadi kesalahan saat menampilkan hasil Tabel Pivot.",
          computeError: "An error occurred computing the PivotTable results.",
          uiRenderError: "An error occurred rendering the PivotTable UI.",
          selectAll: "Pilih Semua",
          selectNone: "Tidak Memilih",
          tooMany: "(terlalu banyak data untuk dicantumkan)",
          filterResults: "Nilai Filter",
          apply: "Terapkan",
          cancel: "Batal",
          totals: "TOTAL (Rp.)",
          vs: "vs",
    ...
    mthNamesEn = ["Jan", "Feb", "Mar", "Apr", "Mei", "Jun", "Jul", "Agt", "Sep", "Okt", "Nov", "Des"];
    dayNamesEn = ["Ming", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"];
